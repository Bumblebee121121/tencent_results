...
def main():
 ...
 if a.run_unit_tests:
  ...
  tests=True
 hnsw=load_json(root/"audits"/"e1_hnsw_accuracy.json")
 save_json({"stage":6,"protocol_version":c["stage6_protocol_version"],"stage3_protocol":c["stage3_protocol_version"],"stage4_protocol":c["stage4_protocol_version"],"stage5_baseline_frozen":True,"user_variants_completed":["U1","U2","U3"],"item_variants_completed":["I1","I2","I3","E1"],"test_used_for_model_selection":False,"candidate_cold_start_used_as_model_feature":False,"retrieval_id_used_as_model_item_id":False,"future_item_strength_used":False,"unseen_candidates_indexed_with_non_id_features":True,"hnsw_accuracy_passed":bool(hnsw["passed"]),"all_stage6_tests_passed":tests,"fusion_completed":True,"debug":a.debug},manifest,a.overwrite)
